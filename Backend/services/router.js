...
router.route("/").get(basic_info.get);

router.route("/login_pracownicy").post(pracownicy.login);

router.route("/login_uczestnicy").post(login_uczestnicy.post);

router.route("/domy_kultury/:id?").get(domy_kultury.get);
...
router.route("/stanowiska/:id?").get(stanowiska.get);
...
router
  .route("/sala_zasoby/:id?") // id sali
  .get(sala_zasoby.get);

router.route("/kategorie_zasobu/:id?").get(kategorie_zasobu.get);
...
router.route("/zasoby").get(zasoby.get);
...
router.route("/wydarzenia").get(wydarzenia.get);
...
//   poczta: string
//}
router.route("/pracownicy").get(pracownicy.get).put(pracownicy.put);
...
router
  .route("/wydarzenia_uczestnika/:id?") // id uczestnika
